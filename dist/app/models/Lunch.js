...
/*#__PURE__*/
function (_Model) {
  _inherits(Lunch, _Model);

  function Lunch() {
    _classCallCheck(this, Lunch);

    return _possibleConstructorReturn(this, _getPrototypeOf(Lunch).apply(this, arguments));
  }

  _createClass(Lunch, null, [{
    key: "init",
    value: function init(sequelize) {
      _get(_getPrototypeOf(Lunch), "init", this).call(this, {
